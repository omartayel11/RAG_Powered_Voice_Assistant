...
# Connect to the ChromaDB server on the VM using the public IP and port 8000
chroma_client = chromadb.HttpClient(host='20.74.230.182', port=8000)  # Use the public IP of your VM
...
recipes_data = [
 ...
 ("شوربة لسان العصفور", 
     "شوربة لسان العصفور دي أكلة مصرية شهيرة في كل بيت، طعمها لذيذ وسريعة التحضير.",
     "نص كوب مكرونة لسان عصفور، ٣ حبات مستكة، هيل، زعفران، مكعب مرقة دجاج، نص إصبع زبدة ٦٠ جرام أو زيت حسب الرغبة، لتر ماء.",
     "في حلة كبيرة، نحط الزبدة ونضيف الكزبرة المستكة والهيل ونقلبهم لحد ما يطلع منهم ريحة حلوة، بعد كده نضيف المكرونة ونقلبها مع باقي المكونات، بعد كده نضيف الماء ومكعب مرقة الدجاج ونخليهم يغلو شوية. بعد ما يغلي، نضيف الزعفران ونتركه يغلي لمدة ٥ دقائق علشان يتشربوا كلهم الطعم.",
     "شوربة", "recipe_6")
